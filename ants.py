...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
                ...
                # BEGIN Problem 9
                #modify so that a container and noncontainer in one place
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if insect.true_queen:
                self.ant = insect
            elif insect.armor == 0 and insect.true_queen:
                bees_win()
        ...
        if insect.is_ant and insect != None and insect.true_queen:
            insect.place = self
        else:
            insect.place = None
...
class Insect(object):
    ...
    def action(self, colony, queen=False):
...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        "*** YOUR CODE HERE ***"
        # END EC
        if self.place.ant != None and self.place.ant.true_queen:
            bees_win()
        if self.blocked():
...
class ThrowerAnt(Ant):
    ...
    def action(self, colony):
        ...
        #Insect.action(self, colony, queen)
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        for bee in self.place.bees[:]:
            ...
            if amount >= self.armor and bee.place is not None:
...
class NinjaAnt(Ant):
    ...
    def action(self, colony, queen=False):
        ...
        copy_bees = list(flying_bees)
        for bee in copy_bees:
            bee.reduce_armor(self.damage)
        no_dead_bees = [bee_elem for bee_elem in copy_bees if bee_elem.armor>0]
        self.place.bees = no_dead_bees
        # END Problem 7
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        #return true if the ant doesn't contain another ant, ant is not a container
    ...
    def contain_ant(self, ant):
        ...
        #self.contained_ant =  ant
        #sets the bodyguards contained_ant instance attribute to the passed in ant argument?
        # END Problem 9
    ...
    def action(self, colony):
        ...
        #perform its contained_ant action?
        # END Problem 9
...
# END Problem 13
    ...
    def ants_behind(self, position):
        list_of_ants = []
        if isinstance(position.ant, TankAnt):
            position = position.exit
        while position.exit != None:
            if position.ant is not None:
                if isinstance(position.ant, TankAnt) and position.ant.contained_ant is not None:
                    if position.ant.contained_ant.doubled == False:
                        list_of_ants.append(position.ant.contained_ant)
                if position.ant.doubled == False:
                    list_of_ants.append(position.ant)
            position = position.exit
        return list_of_ants
    ...
    def action(self, colony):
        ...
        if self.true_queen == True:
            ...
            list = self.ants_behind(self.place)
            for ant in list:
                if isinstance(ant, BodyguardAnt) and ant.contained_ant is not None:
                    Insect.action(ant.contained_ant, colony, True)
                Insect.action(ant,colony, True)
        else:
